...
class WhaleOptimization():
    ...
    """
    def __init__(self, opt_func, opt_func_data, constraints, nsols, b, a, a_step, maximize=False):
        self._opt_func = opt_func
        self._opt_func_data = opt_func_data
    ...
    def _rank_solutions(self):
        """find best solution"""
        fitness = self._opt_func(self._sols[:, 0], self._sols[:, 1], self._opt_func_data)
